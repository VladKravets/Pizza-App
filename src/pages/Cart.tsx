            ...
            <div className="cart">
                ...
                <div className="content__items">
                    <div className="cart__item">
                        ...
                        <div className="cart__item-info">
                            <h3>Маргарита</h3><p>тонкое, 26 см.</p></div>
                        ...
                        <div className="cart__item-price"><b>450 ₽</b></div>
                    ...
                    <div className="cart__item">
                        ...
                        <div className="cart__item-price"><b>1185 ₽</b></div>
                        <div className="cart__item-remove">
                            <div className="button button--outline button--circle">
                                <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="cart__bottom">
                    <div className="cart__bottom-details">
                        <span> Всего пицц: <b>4 шт.</b> </span>
                        <span> Сумма заказа: <b>1635 ₽</b> </span>
                    </div>
                    <div className="cart__bottom-buttons">
                        <Link
                            ...
                            <svg
                                ...
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M7 13L1 6.93015L6.86175 1" stroke="#D3D3D3"
